...
import format.scroll.ScrollBarCustomComboBox;
...
public class ComboSuggestionUI extends BasicComboBoxUI{
        ...
        private class ComboSuggestionPopup extends BasicComboPopup {
            ...
            protected JScrollPane createScroller() {
                ...
                ScrollBarCustomComboBox sb = new ScrollBarCustomComboBox();
                sb.setPreferredSize(new Dimension(12, 70));
                scroll.setVerticalScrollBar(sb);
                ScrollBarCustomComboBox sbH = new ScrollBarCustomComboBox();
