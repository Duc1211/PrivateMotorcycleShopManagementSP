...
public class FormAutomaticScooter extends PanelRound {
    ...
    public FormAutomaticScooter() throws SQLException {
        initComponents();
    ...
    private void init() throws SQLException {
        ...
        listVehicle = vehicleDao.getVehicleByType("Automatic Scooter");
        testData();
    }
    ...
    private void testData() throws SQLException {
        ...
        vehicleDao = new VehicleDao();
        listVehicle = vehicleDao.getVehicleByType("RANGE02");
        int ID = 1;
        for (int i = 0; i <= 5; i++) {
